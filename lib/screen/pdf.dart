                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('* ${l1[4]['email']}',style: const TextStyle(
                          fontWeight: FontWeight.w300,
                          fontSize: 6,
                          color: Colors.black),),
                      Text('* ${l1[4]['companyname']}',style: const TextStyle(
                          fontWeight: FontWeight.w300,
                          fontSize: 6,
                          color: Colors.black),),
                      Text('* ${l1[4]['phone']}',style: const TextStyle(
                          fontWeight: FontWeight.w300,
                          fontSize: 6,
                          color: Colors.black),)
                    ],
        ...
        return  pd.Stack(children: [
            ...
            pd.Row(children: [
              pd.Center(
                child: pd.Padding(
                  padding:
                  const pd.EdgeInsets.only(left: 28.0, top: 70),
                  child: pd.Column(
                      crossAxisAlignment:
              ...
              pd.Padding(
                padding: const pd.EdgeInsets.only(
                    left: 65.0, top: 80, right: 5),
                child: pd.Column(
                  crossAxisAlignment: pd.CrossAxisAlignment.start,
                  children: [
                    pd.Row(
